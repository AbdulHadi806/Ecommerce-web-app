...
export default function CheckOut() {
  ...
  const LoginHandler = (e) => {
    ...
    dispatch(
      userLoginHandler({
        FirstName: userLoginName,
        LastName: userLoginLastName,
        Email: userLoginEmail,
        Number: userLoginNumber,
        address: userLoginAddress,
        id: Math.random(),
      })
    );
    setUserLoginName("");
              ...
              <CardContent>
                ...
                <form onSubmit={LoginHandler}>
                  <Grid container spacing={1}>
                    ...
                    <Grid xs={12} sm={6} item>
                      <TextField
                        value={userLoginLastName}
                        onChange={(e) => setUserLoginLastName(e.target.value)}
                    ...
                    <Grid item xs={12}>
                      <TextField
                        value={userLoginNumber}
                        onChange={(e) => setUserLoginNumber(e.target.value)}
                        type="number"
                    ...
                    <Grid item xs={12}>
                      <TextField
                        value={userLoginAddress}
                        onChange={(e) => setUserLoginAddress(e.target.value)}
                        multiline
